	...
	<ul id="menu">
		...
		<li>
			...
			<ul>
				...
				%>
				<li><a class="label"
					href="<%=param1%>?action=category&categoryId=<%=category.getId()%>&category=<%=category.getCategoryDescription()%>"><span
						class="label" style="margin-left: 30px;"><%=category.getCategoryDescription()%></span></a>
				</li>
				<%
					}
				%>
